...
export const constantRouterMap = [
  ...
  // 卸货
  {
    ...
    children: [
      ...
      {
        path: 'disburdenContent',
        name: 'DisburdenContent',
        component: () => import('@/views/disburden/disburdenContent'),
        meta: { title: '卸货内容', icon: 'example' }
      }
    ]
  },
  // 出货
  {
    ...
    component: Layout,
    name: 'Shipment',
    meta: { title: '出货模块', icon: 'example' },
    children: [
      {
        path: 'shipmentStart',
        name: 'ShipmentStart',
        component: () => import('@/views/shipment/shipmentStart'),
        meta: { title: '开始出货', icon: 'example' }
      },
      {
        path: 'shipmentContent',
        name: 'ShipmentContent',
        component: () => import('@/views/shipment/shipmentContent'),
        meta: { title: '出货内容', icon: 'example' }
      }
    ]
  },
  // 财务账单
  ...
  // 商机
  {
    ...
    children: [
      ...
      },
      {
        path: 'barCode',
        name: 'BarCode',
        component: () => import('@/views/business/barCode'),
        meta: { title: '条码设置', icon: 'example' }
      }
    ]
  },
  // 基础设置
